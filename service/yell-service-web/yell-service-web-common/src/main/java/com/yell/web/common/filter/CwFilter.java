package com.yell.web.common.filter;
...
//            //权限判断
//            if(!checkSessionTimeout(request, response)){
//                if(ObjectHelper.isNotEmpty(CPContext.getContext())&&ObjectHelper.isNotEmpty(CPContext.getContext().getAuthUrls())){
//                    if(!CPContext.getContext().getAuthUrls().contains(uri)&&!CPContext.getContext().getType().equalsIgnoreCase("admin")){
