...
public class HttpClientUtil {
     ...
     * @return 字符串
     */
    public static String convertStringParamter(Map parameterMap) throws UnsupportedEncodingException {
        ...
        if (parameterMap != null) {
            ...
            while (iterator.hasNext()) {
                ...
                if (parameterMap.get(key) != null) {
                    value = URLEncoder.encode((String) parameterMap.get(key),"UTF-8");
                } else {
                    value = "";
                }
